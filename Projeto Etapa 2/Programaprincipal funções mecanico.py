...
def listarTodos(arquivoNome, mat):
    print("-" * 30)
...
def listarUmElemento(arquivoNome, mat):
    print("-" * 30)
    arquivo = open(arquivoNome, "r")
    for linha in arquivo:
        linha = linha.replace("\n","")
...
def alterarElemento(nomeArquivo, mat):
    print("-" * 30)
...
def excluirElemento(arquivoNome, mat):
    print("-" * 30)
        ...
        if opc not in range(1,3):
            ...
            while True:
                ...
                if mec == 1:
                    ...
                    listarTodos(dadosmecanico, matMecanico)
                if mec == 2:
                    print(listamecanico[1])
                    listarUmElemento(dadosmecanico, matMecanico)
                if mec == 3:
                    print(listamecanico[2])
                    incluirMecanico(dadosmecanico)
                if mec == 4:
                    print(listamecanico[3])
                    alterarElemento(dadosmecanico, matMecanico)
                if mec == 5:
                    print(listamecanico[4])
                    excluirElemento(dadosmecanico, matMecanico)
