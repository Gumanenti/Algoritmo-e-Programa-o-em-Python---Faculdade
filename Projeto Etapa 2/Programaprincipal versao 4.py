...
def alterarMecanico(nomeArquivo, mat):
    ...
    if cpfalterar in mat[a][0]:
        ...
        datanasc = input("Digite a nova datanasc: ")
        ...
        while True:
            ...
            if maistelefone in "Nn":
                break
        novos_dadosmecanicos = cpf+";"+nome+";"+datanasc+";"+sexo+";"+salario+";"+todosemails+";"+todostelefones+"\n" 
...
def alterarVeiculo(nomeArquivo, mat):
    ...
    if placaalterar in mat[a][0]:
        ...
        portas = input("Digite o novo número de Portas: ")
        combustivel = input("Digite o novo tipo de Combustível: ")
...
def alterarConserto(nomeArquivo, mat):
    ...
    a = 0
    x = str(input("Digite o CPF que deseja alterar: "))
    y = str(input("Digite a Placa que deseja alterar: "))
    z = str(input("Digite a data de Entrada que deseja alterar: "))
    ...
    if x in str(mat[a][0]) and y in str(mat[a][1]) and z in str(mat[a][2]):
        ...
        cpf = input("Digite o novo CPF: ")
        placa = input("Digite a nova Placa: ")
        dataEntrada = input("Digite a nova data de entrada: ")
        dataSaida = input("Digite a nova data de saida: ")
        todosproblemas = ""
        while True:
            problema = str(input("Digite um problema do Veículo: "))
            maisproblema = str(input("Quer acrescentar mais um problema do Veículo? [S/N] "))
        ...
        novos_dadosconserto = cpf+";"+placa+";"+dataEntrada+";"+dataSaida+";"+todosproblemas+";"+valorconserto+"\n"
...
def entreDatas(mat, arquivoNome):
    ...
    dataAte = []
    diaAte = input("Digite o dia da data final(Ex: 01): ")
    dataAte.append(diaAte)
    mesAte = input("Digite o mês da data final(Ex: 03): ")
    dataAte.append(mesAte)
    anoAte = input("Digite o ano da data final(Ex: 2021): ")
...
listamenu = ["Menu Mecânicos", "Menu Veículos", "Menu Consertos", "Menu Relatórios", "Sair"]
...
try:
    ...
    while True:
        ...
        if opc not in range(1,6):
            ...
            while mec != 0:
                print("-" * 30)
                mec = int(input("Digite a sua opção neste menu ou 0 para voltar ao Menu de Opções: "))
                print("-" * 30)
            ...
            while mec != 0:
                ...
                if mec not in range(0, 6):
                    ...
                    datanasc(matMecanico, dadosmecanico)
                elif mec == 2:
